...
When authorized, use a private disposable adopter repository by default. An
explicitly approved public disposable repository may be used for public-runner
acceptance with nonsensitive fixture content; keep credentials in encrypted
Actions secrets and live traces out of committed files. Retain evidence for:
