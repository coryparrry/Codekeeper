...
| [Multi-agent orchestration](MULTI_AGENT_ORCHESTRATION_SPEC.md)        | Specification | Implement manager-led specialists, review and label ownership, bounded repair, and human decision gates.      |
| [Multi-agent orchestration tasks](MULTI_AGENT_ORCHESTRATION_TASKS.md) | How-to        | Deliver the specification through dependency-ordered, independently reviewable pull requests.                 |
