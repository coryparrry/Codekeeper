...
- **Child ticket**: a GitHub sub-issue, falling back to a task-list entry when sub-issues are unavailable.
- **Blocking**: use GitHub’s native issue dependencies, falling back to a `Blocked by:` line.
