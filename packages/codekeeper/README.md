...
| [Source installation guide](https://github.com/coryparry/Codekeeper/blob/6e929e4289094b57976d7bdec0e7ad6546a8e61d/INSTALL.md) | Full manual installation and credential boundaries at the pinned runtime checkpoint. | When auditing the generated setup or using the manual fallback. |
...
| [Packaged default profiles](https://github.com/coryparry/Codekeeper/tree/6e929e4289094b57976d7bdec0e7ad6546a8e61d/tools/codekeeper/agents) | Immutable source and provenance for the four defaults bundled with this release. | When comparing an optional repository override with the release baseline. |
