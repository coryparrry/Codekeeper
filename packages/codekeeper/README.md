...
| [Source installation guide](https://github.com/coryparry/Codekeeper/blob/da7e5073d274aeb27edd003a349dcc74324e7831/INSTALL.md) | Full manual installation and credential boundaries at the pinned runtime checkpoint. | When auditing the generated setup or using the manual fallback. |
...
| [Packaged default profiles](https://github.com/coryparry/Codekeeper/tree/da7e5073d274aeb27edd003a349dcc74324e7831/tools/codekeeper/agents) | Immutable source and provenance for the four defaults bundled with this release. | When comparing an optional repository override with the release baseline. |
