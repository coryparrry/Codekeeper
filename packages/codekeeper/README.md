...
| [Source installation guide](https://github.com/coryparrry/Codekeeper/blob/cb299949600941c1d6a32d84d31782d6cc464f0d/INSTALL.md) | Full manual installation and credential boundaries at the pinned runtime checkpoint. | When auditing the generated setup or using the manual fallback. |
...
| [Canonical starter profiles](https://github.com/coryparrry/Codekeeper/tree/cb299949600941c1d6a32d84d31782d6cc464f0d/tools/codekeeper/agents) | Immutable source and provenance for the four starter Markdown files copied by this installer. | When comparing local profile changes with the release baseline. |
...
2. Keeps every reusable-workflow and bootstrap reference pinned to source commit `cb299949600941c1d6a32d84d31782d6cc464f0d`.
