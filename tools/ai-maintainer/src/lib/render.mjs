function safeMarkdown(value) {
  return String(value ?? "")
    .replace(/<!--\s*ai-maintainer:/gi, "&lt;!-- ai-maintainer:")
    .replace(
...
<sub>Generated from the exact PR head analysed by the repository maintainer. Blocking findings fail the required AI maintainer review gate; GitHub branch protection remains authoritative.</sub>`;
}
...
<!-- ai-maintainer:fingerprint=${fingerprint} -->`;
}
...
<!-- ai-maintainer:repair=${fingerprint} -->`;
}
