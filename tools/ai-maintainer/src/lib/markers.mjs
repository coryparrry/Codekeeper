...
export const REVIEW_MARKER = "<!-- ai-maintainer:review -->";
export const ISSUE_TRIAGE_MARKER = "<!-- ai-maintainer:issue-triage -->";
...
export function findingMarker(fingerprint) {
  return `<!-- ai-maintainer:fingerprint=${fingerprint} -->`;
}
